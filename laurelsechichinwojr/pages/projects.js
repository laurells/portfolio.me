...
export async function getStaticProps() {
  const meta = {
    title: 'Projects // Laurels Echichinwo Jr.',
...
function Projects(props) {
  ...
  const description = `I'm passionate about side projects and <strong>building in public</strong>. Here you can navigate to <strong>${getTotalProjects()} different</strong> websites I built by myself and with the team I have worked with.`
