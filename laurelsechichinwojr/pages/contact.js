...
export async function getStaticProps() {
  const meta = {
    title: 'Contact // Laurels Echichinwo Jr.',
    tagline: 'Email me.',
...
function Contact(props) {
  ...
  const description = `<p>I enjoy conversing with software engineers, tech founders, students, and creators. While my schedule is often full, I may not be able to reply immediately to your email, but I'll do my utmost to respond promptly.</p>`
      ...
      <Box>
        ...
        <Form onSubmit={onSendEmail}>
          ...
          <FormGroup>
            ...
            <Input id="email" type="email" placeholder="jane@jim.com" required />
          </FormGroup>
          <FormGroup>
            <Label htmlFor="message">Message</Label>
            <Textarea id="message" placeholder="Do you need a service?" rows="4" required />
          </FormGroup>
          <FormGroup>
